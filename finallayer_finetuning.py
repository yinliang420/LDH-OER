...
from ocpmodels.models.equiformer_v2.equiformer_v2_oc20 import EquiformerV2_f, EquiformerV2_OC20, EquiformerV2_final
...
def train(model, data_loader, optimizer, num_epochs, criterion, normalizers, device, save_best: bool,
    ...
    if save_best is True:
        print("finallayerTrain_loss: ", train_losses)
        print("finallayerValid_losses: ", valid_losses)
        print("finallayerBest_loss: ", best_loss, "\t", valid_losses.index(best_loss))
    else:
...
if __name__ == "__main__":
    ...
    for nums in numlist:
        ...
        for fold, (train_index, valid_index) in enumerate(kf.split(split_data)):
            ...
            lr_dropout1 = 0.5
            lr_dropout2 = 0.5
            my_model = EquiformerV2_final(equiformer, layer_output, lr_dropout1, lr_dropout2)
