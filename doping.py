        ...
        # for phase in ['train']:
            ...
            if phase == 'valid' and epoch_loss < best_loss:
                ...
                if save_best is True:
                    ...
                    filename = f'path_to_save\\{nums}-{fold}-doping.pt'
...
if __name__ == "__main__":
    ...
    for nums in numlist:
        ...
        for fold, (train_index, valid_index) in enumerate(kf.split(split_data)):
            ...
            lr_layer1 = 0.006540819672177652
            lr_layer2 = 0.008908279668650421
        ...
        with open(f"path_to_save\\{nums}-vaildloss.txt", 'a')as f:
